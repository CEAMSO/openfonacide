...
partial_patterns = patterns('',
    ...
    url(r'^search\.html$', PartialGroupView.as_view(template_name='search.html'), name='search.html'),
     url(r'^search-id\.html$', PartialGroupView.as_view(template_name='search-id.html'), name='search-id.html'),
    ...
    url(r'^contraloria-vinculacion\.html$', PartialGroupView.as_view(template_name='contraloria-vinculacion.html'), name='contraloria-vinculacion.html'),
...
urlpatterns = patterns('',
    ...
    url(r'^agua$',   TemplateView.as_view(template_name='visualizaciones/agua.html'), name="agua"),
     url(r'^agua-datos?$',   TemplateView.as_view(template_name='visualizaciones/agua-datos.html'), name="agua-datos"),
      url(r'^agua-diccionario?$',   TemplateView.as_view(template_name='visualizaciones/agua-diccionario.html'), name="agua-diccionario"),
    url(r'^mobiliarios$',   TemplateView.as_view(template_name='visualizaciones/mobiliarios.html'), name="mobiliarios"),
      url(r'^mobiliarios-datos?$',   TemplateView.as_view(template_name='visualizaciones/mobiliarios-datos.html'), name="mobiliarios-datos"),
       url(r'^mobiliarios-diccionario?$',   TemplateView.as_view(template_name='visualizaciones/mobiliarios-diccionario.html'), name="mobiliarios-diccionarios"),
    ...
    url(r'^contraloria_vinculacion/?$',  contraloria_vinculacion, name='contraloria_vinculacion'),
